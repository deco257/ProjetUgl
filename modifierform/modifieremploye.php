...
<head>
    ...
    <title>modifier les employés</title>
...
<input class="form-control"  type="" placeholder="entrez le matricule.."  autocomplete="off" name="matricule"  required>
          ...
          <input  class="form-control" type="" placeholder="entrez le nom.."title="ne depassez pas 255 caracteres" autocomplete="off" name="nom"  required >
                                  
                                  
                      <label  class ="label-control "for="prenom">prenom</label>
                      
    <input  class="form-control" type="" placeholder="entrez le prenom.." title="ne depassez pas 255 caracteres" autocomplete="off" name="prenom" required >
                      
                      <label  class ="label-control "for="tel">telephone</label>
                      
  <input  class="form-control" type="tel" placeholder="entrez votre numero de telephone.."  title="ne depassez pas 255 caracteres"autocomplete="off" name="tel" required >
              
              
<label  class ="label-control" for="email">email</label>
              
<input  class="form-control" type="email" placeholder="entrez votre mail.." title="ne depassez pas 255 caracteres" autocomplete="off" name="email" required >
                  
<label  class ="label-control"for="fonction">fonction</label>
                  
<input  class="form-control" type="" placeholder="entrez votre fonction.."  title="ne depassez pas 255 caracteres"autocomplete="off"  name="fonction" required >
...
<button  type="submit" name="save" type="button" class="btn btn-warning">modifier</button>
</form>

...
require('bdd.php');
session_start();
if($_SESSION['rolees']!='admi'){
  header('location:table.php');
}
$req=$bdd->prepare("INSERT INTO typesalle(num_typesalle) VALUES(?)");
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="dashbord.php" class="btn btn-primary">dashbord</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu bg-info" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="salles.php">
                    ...
                    <a class="dropdown-item" href="typesalle.php">type salle</a>
                    </a></li>
...
<h4>saisit numero typesalle</h4>
  <label> num</label>
  <input type="" name="num"placeholder="numero type salle.." maxwidth="2" 
  title ="vous ne pouvez pas depasser 2chifres" required>

...
$req=$bdd->prepare("SELECT* FROM typesalle");
$req->execute([]);
$deco=$req->fetchAll();
...
if(isset($_POST['save'])){
  $req=$bdd->prepare("INSERT INTO salles(num_salle,nom_salle,id_bloc,id_typesalle)VALUES (?,?,?,?)");
  $req->execute([$_POST['num_salle'],$_POST['nom_salle'],$_POST['bloc'],$_POST['type']]);
}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="">
                          <label for="num" class="label-control">num salle</label>
                          <input     class="form-control" type="" name="num_salle" id="num" placeholder="nom du salle" required>

                          <label for="nom" class="label-control">nom salle</label>
                          <input      class="form-control" type="" name="nom_salle" id="nom" placeholder="nom du salle" required>



                          <label for="bloc" class="label-control">bloc</label>
                          <select class="form-select" name="bloc">
                          <?php foreach($DEV as $deve):?>
                          <option value="<?=$deve['id_bloc']?>"><?=$deve['num_bloc']?></option>
                          <?php endforeach?>
                          </select>

                          <label for="typesalle"class="label-control"> numero ype salle</label>
                          <select  class="form-select" name="type" id="typesalle">
                            <?php foreach($deco as $trouve):?>
                
                          <option value="<?=$trouve['id_typesalle']?>"><?= $trouve['num_typesalle']?></option>
                          <?php endforeach?>
                          </select>
                                ...
                                <div class="modal-footer">
                                  ...
                                  <button type="submit" class="btn btn-primary" name="save">erengistrez</button>
                                </div>
              </form>
              </div>
          </div>
